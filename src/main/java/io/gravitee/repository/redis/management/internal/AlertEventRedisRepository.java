 ...
 */
public interface AlertEventRedisRepository {
    Page<RedisAlertEvent> search(AlertEventCriteria criteria, Pageable pageable);
    RedisAlertEvent findById(String event);
    RedisAlertEvent saveOrUpdate(RedisAlertEvent event);
